...
const TeamMemberCard: React.FC<TeamMemberCardProps> = ({
  ...
  const cardHeight = isTechMember ? "h-[630px]" : "h-[600px]";
      ...
      >
        ...
        <div className="relative mb-6 flex-shrink-0">
          {member.photo && !imageError ? (
            <div className="w-full h-45 mx-auto rounded-2xl overflow-hidden shadow-lg ring-2 ring-white group">
              <img
                src={member.photo}
            ...
            <div
              className={`w-20 h-20 mx-auto bg-gradient-to-br ${avatarGradient} rounded-2xl flex items-center justify-center text-white font-bold text-xl shadow-lg hover:scale-105 transition-transform duration-300`}
            >
              {member.avatar}
            </div>
          )}
        ...
        <div className="text-center mb-6 flex-grow min-h-0">
          ...
          <p
            className={`${isTechMember ? "text-blue-600" : "text-cyan-600"
